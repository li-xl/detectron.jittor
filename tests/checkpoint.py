...
from detectron.utils.checkpoint import Checkpointer
...
class TestCheckpointer(unittest.TestCase):
    ...
    def create_complex_model(self):
        ...
        state_dict["layer1.weight"] = jt.rand(3, 2)
        state_dict["layer1.bias"] = jt.rand(3)
        state_dict["layer2.weight"] = jt.rand(2, 3)
        state_dict["layer2.bias"] = jt.rand(2)
        state_dict["res.layer2.weight"] = jt.rand(2, 3)
        state_dict["res.layer2.bias"] = jt.rand(2)
    ...
    def test_complex_model_loaded(self):
        for add_data_parallel in [False]:
